...
def assign_to_me_all(username,password,url,time):
	print("Welcome to GoalKeeper v0.3 | A Kevin Song Production")
	sleep(2)
	...
	while True:
		...
		if incidents_numbers == 0:
			...
			if updated.startswith('j'):
				...
				updated_time = int(re.sub("\D","",updated))
...
assign_to_me_all('KEVISONG','Schenker160503!10',url,25)